---
name: c3d-planner-xhigh
description: Planner at raised reasoning effort, rung 2/3 of the ladder: earlier plans failed, so a wrong framing is more likely than a hard problem.
